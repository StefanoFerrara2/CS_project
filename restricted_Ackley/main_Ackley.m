...
% Ackley function and compares to the high-fidelity Monte Carlo estimate
...
title([method,' main sensitivity estimates for Restricted Ackley function'],'interpreter','latex')
...
if strcmp(method,'Owen') || strcmp(method,'Saltelli')
    ...
    bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
    title([method,' total sensitivity estimates for Restricted Ackley function'],'interpreter','latex')
end
...
title('Variance estimates for Restricted Ackley function','interpreter','latex')