...
title([method,' main sensitivity estimates for Ackley function'],'interpreter','latex')
...
if strcmp(method,'Owen') || strcmp(method,'Saltelli')
    ...
    bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
    title([method,' total sensitivity estimates for Ackley function'],'interpreter','latex')
end
...
title('Variance estimates for Ackley function','interpreter','latex')